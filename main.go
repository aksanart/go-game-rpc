...
import (
	...
	"github.com/aksanart/go-game-rpc/entities"
...
func (g *Game) Update() error {
	...
	for _, sprite := range g.enemies {
		if sprite.IsFollowPlayer {
			...
			if sprite.X == g.player.X && sprite.Y == g.player.Y {
				g.player.Health -= sprite.Damage
				fmt.Printf("get damaged Health: %d\n", g.player.Health)
			}
		}
